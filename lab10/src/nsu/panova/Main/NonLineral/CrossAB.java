...
public class CrossAB {
    ...
    private void fillData() {
        ...
        y_end = tau * SIZEY;
        System.out.println("Нелинейный крест AB. x_end = " + x_end + " y_end = " + y_end);
        ...
        try {
            ...
            for (int i = 0; i < SIZE; i++) {
                String result = String.format("%.3f;%.3f;%.3f;%.3f;\n", (i * (x_end - x_start) / SIZE + 0.001),
                        z_real_ab[i][SIZEY / 3], z_cross[i][SIZEY / 3],
                        z_cross_2[i * 2][SIZEY * 2 / 3]).replace('.', ',');
